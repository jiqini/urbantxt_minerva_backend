  ...
  async populateDatabase(): Promise<void> {
    ...
    const legalDocuments = [
      ...
      },
      {
        ...
        content:
          'Para interponer una demanda de alimentos se debe presentar ante el Juzgado de Familia correspondiente al domicilio del demandado o del demandante. La demanda debe contener: 1) Identificación completa de las partes, 2) Los hechos en que se funda la pretensión, 3) La cuantía de la pensión solicitada, 4) Las pruebas que se pretenden hacer valer.',
        source: 'CENDOJ',
      ...
      },
      {
        ...
        content:
          'Los plazos procesales en materia civil son: Para contestar demanda: 3 días hábiles. Para interponer apelación: 3 días hábiles. Para presentar alegatos: 3 días hábiles. Para evacuar pruebas: 10 días hábiles. Todos los plazos se cuentan en días hábiles, excluyendo sábados, domingos y días feriados.',
        source: 'CSJ',
        document_type: 'procedure',
        metadata: JSON.stringify({
