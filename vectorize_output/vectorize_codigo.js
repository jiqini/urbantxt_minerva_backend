...
`.trim();
    ...
    for (let attempt = 0; attempt < 3; attempt++) {
        try {
            ...
            model: 'gpt-3.5-turbo',
            messages: [
                { role: 'system', content: 'You are a legal expert specializing in El Salvador’s civil procedure and civil code. Only respond with valid tags from the approved list and no extra commentary.' },
        ...
        for (const element of data) {
            ...
            for (const chunkText of chunks) {
                ...
                if (exists) {
                    ...
                    chunkCount++;
                    console.log(`[MongoDB] Inserted chunk #${chunkCount}:`, doc.text.slice(0, 60) + '...');
                }
            }
        }
