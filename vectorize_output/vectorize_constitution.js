...
`.trim();
    ...
    for (let attempt = 0; attempt < 3; attempt++) {
        try {
            ...
            model: 'gpt-3.5-turbo',
            messages: [
                { role: 'system', content: 'You are a legal expert specializing in El Salvador’s Constitution. Only respond with valid tags from the approved list and no extra commentary.' },
